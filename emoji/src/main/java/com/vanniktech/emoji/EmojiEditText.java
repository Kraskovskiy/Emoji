...
import com.vanniktech.emoji.listeners.OnEmojiInputTextListener;
...
public class EmojiEditText extends AppCompatEditText implements EmojiEditable {
    ...
    @Nullable
    private OnEmojiInputTextListener emojiInputTextListener;
    ...
    public void setEmojiInputTextListener(@Nullable OnEmojiInputTextListener emojiInputTextListener) {
        this.emojiInputTextListener = emojiInputTextListener;
    }
}
