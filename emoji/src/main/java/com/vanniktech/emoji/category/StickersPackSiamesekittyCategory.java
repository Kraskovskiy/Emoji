...
@SuppressWarnings("PMD.MethodReturnsInternalArray") public final class StickersPackSiamesekittyCategory implements EmojiCategory {
    private static final Emoji[] DATA = new Emoji[] {
            ...
            new Emoji(390003, new String[]{"smiling_face_with_3_hearts"},R.drawable.stickers_pack_siamesekitty_n3),
            ...
            new Emoji(390019, new String[]{"smiling_face_with_3_hearts"}, R.drawable.stickers_pack_siamesekitty_n19),
