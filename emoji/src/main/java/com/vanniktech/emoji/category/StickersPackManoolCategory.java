...
@SuppressWarnings("PMD.MethodReturnsInternalArray") public final class StickersPackManoolCategory implements EmojiCategory {
    private static final Emoji[] DATA = new Emoji[] {
            new Emoji(360001, new String[]{"laughing", "slightly_smiling_face", "joy", "rolling_on_the_floor_laughing", "sweat_smile", "satisfied", "grin", "smile", "smiley", "grinning"}, R.drawable.stickers_pack_manool_n1),
            new Emoji(360002, new String[]{"kissing_heart", "kissing_smiling_eyes", "kissing_closed_eyes"}, R.drawable.stickers_pack_manool_n2),
            ...
            new Emoji(360010, new String[]{"unamused"}, R.drawable.stickers_pack_manool_n10),
            new Emoji(360011, new String[]{"wave"}, R.drawable.stickers_pack_manool_n11),
            new Emoji(360012, new String[]{"man-bowing", "woman-bowing"}, R.drawable.stickers_pack_manool_n12),
            new Emoji(360013, new String[]{"partying_face", "gift"}, R.drawable.stickers_pack_manool_n13),
            new Emoji(360014, new String[]{"sleeping"}, R.drawable.stickers_pack_manool_n14),
            ...
            new Emoji(360022, new String[]{"stuck_out_tongue_winking_eye"}, R.drawable.stickers_pack_manool_n22),
            new Emoji(360023, R.drawable.stickers_pack_manool_n23, true),
            new Emoji(360024, R.drawable.stickers_pack_manool_n24, true),
            new Emoji(360025, new String[]{"sob"}, R.drawable.stickers_pack_manool_n25),
            new Emoji(360026, new String[]{"relieved"}, R.drawable.stickers_pack_manool_n26),
