...
@SuppressWarnings("PMD.MethodReturnsInternalArray") public final class StickersPackManoolgirlCategory implements EmojiCategory {
    private static final Emoji[] DATA = new Emoji[] {
            new Emoji(370001, new String[]{"laughing", "slightly_smiling_face", "joy", "rolling_on_the_floor_laughing", "sweat_smile", "grin", "smile", "smiley", "grinning"}, R.drawable.stickers_pack_manoolgirl_n1),
            new Emoji(370002, new String[]{"kissing_heart", "kissing_smiling_eyes", "kissing_closed_eyes"}, R.drawable.stickers_pack_manoolgirl_n2),
            ...
            new Emoji(370005, new String[]{"wave"}, R.drawable.stickers_pack_manoolgirl_n5),
            ...
            new Emoji(370011, new String[]{"partying_face"}, R.drawable.stickers_pack_manoolgirl_n11),
            new Emoji(370012, R.drawable.stickers_pack_manoolgirl_n12, true),
            new Emoji(370013, new String[]{"unamused"}, R.drawable.stickers_pack_manoolgirl_n13),
            ...
            new Emoji(370017, new String[]{"thumbsdown"}, R.drawable.stickers_pack_manoolgirl_n17),
            ...
            new Emoji(370023, new String[]{"yum"}, R.drawable.stickers_pack_manoolgirl_n23),
            new Emoji(370024, new String[]{"stuck_out_tongue_winking_eye"}, R.drawable.stickers_pack_manoolgirl_n24),
            ...
            new Emoji(370032, new String[]{"smiling_face_with_3_hearts", "heart"}, R.drawable.stickers_pack_manoolgirl_n32),
            ...
            new Emoji(370035, new String[]{"sob"}, R.drawable.stickers_pack_manoolgirl_n35),
