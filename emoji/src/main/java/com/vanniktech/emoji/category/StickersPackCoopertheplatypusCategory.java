...
@SuppressWarnings("PMD.MethodReturnsInternalArray") public final class StickersPackCoopertheplatypusCategory implements EmojiCategory {
    private static final Emoji[] DATA = new Emoji[] {
            new Emoji(320001, new String[]{"laughing", "slightly_smiling_face", "joy", "rolling_on_the_floor_laughing", "sweat_smile", "grin", "smile", "smiley", "grinning"}, R.drawable.stickers_pack_coopertheplatypus_n1),
            ...
            new Emoji(320005, new String[]{"wave"}, R.drawable.stickers_pack_coopertheplatypus_n5),
            ...
            new Emoji(320015, new String[]{"sleeping"}, R.drawable.stickers_pack_coopertheplatypus_n15),
            new Emoji(320016, R.drawable.stickers_pack_coopertheplatypus_n16, true),
            new Emoji(320017, new String[]{"yum"}, R.drawable.stickers_pack_coopertheplatypus_n17),
            ...
            new Emoji(320024, new String[]{"sunglasses"}, R.drawable.stickers_pack_coopertheplatypus_n24),
