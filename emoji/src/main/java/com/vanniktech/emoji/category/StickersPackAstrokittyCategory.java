...
public final class StickersPackAstrokittyCategory implements EmojiCategory {
    private static final Emoji[] DATA = new Emoji[]{
            ...
            new Emoji(200009, new String[]{"laughing"}, R.drawable.stickers_pack_astrokitty_n9),
            new Emoji(200010, R.drawable.stickers_pack_astrokitty_n10, true),
            new Emoji(200011, new String[]{"kissing_heart"}, R.drawable.stickers_pack_astrokitty_n11),
